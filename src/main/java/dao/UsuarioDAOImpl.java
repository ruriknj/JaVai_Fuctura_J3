...
public class UsuarioDAOImpl implements UsuarioDAO {
	...
	public Usuario confirmaLog(Usuario usuario) {

		System.out.println("lista user inputs 4: " + usuario);

		EntityManager em = JpaUtil.getEntityManager();

		String hql = "SELECT u from Usuario u WHERE u.cpf = :cpfAdm AND u.senha = :senhaAdm";

		Query query = em.createQuery(hql);

		query.setParameter("cpfAdm", usuario.getCpf());
